...
import getpass    #to hide sensitive informations
...
def fetch_random_questions():
    ...
    cursor.execute("SELECT * FROM dsa_questions ORDER BY RAND() LIMIT 10")  # Assuming you want to fetch 10 random questions
...
def register():
    ...
    while True:
        ...
        re_password = getpass.getpass("Enter your password again: ")
